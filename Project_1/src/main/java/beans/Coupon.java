...
public class Coupon {
    ...
    public Coupon(Coupon coupon) {
        this(coupon.getId(), coupon.getCompanyId(), coupon.getCategory(), coupon.getTitle(), coupon.getDescription(), coupon.getStartDate(), coupon.getEndDate(), coupon.getAmount(), coupon.getPrice(), coupon.getImage());
    }
